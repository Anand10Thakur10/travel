...
public class Destination extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text=new String[]{"JW Marriott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Radisson Blue Hotel","Classio HotBreeze Blow Hotel","The Bay club Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel"};
        try{
            for(int i=0;i<9;i++){
    ...
    Destination(){
       ...
       /* caption=new JLabel();
        ...
        for(int i=0;i<9;i++) {
            image[i] = new ImageIcon(Destination.class.getResource("/icons/dest"+(i+1)+".jpg"));
